package com.sunnyweather.joygin.logic.model
...
private val sky = mapOf(
    ...
    "WIND" to Sky("大风", R.drawable.ic_light_rain, R.drawable.bg_wind),
    ...
    "THUNDER_SHOWER" to Sky("雷阵雨", R.drawable.ic_heavy_rain, R.drawable.bg_rain),
    "SLEET" to Sky("雨夹雪", R.drawable.ic_sleet, R.drawable.bg_rain),
    "LIGHT_SHOW" to Sky("小雪", R.drawable.ic_light_snow, R.drawable.bg_rain),
    "MODERATE_SHOW" to Sky("中雪", R.drawable.ic_moderate_snow, R.drawable.bg_snow),
